        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <ul class="nav navbar-right top-nav">
             ...
             <b class="caret"></b></a>
					...
					<li>
                        <a href="changepassword.php"><i class="fa fa-users fa-lg"></i>&nbsp; Change Password</a>
                    </li>
					<li class="divider"></li>
                    <li>
        ...
        <?php $image = $_SESSION['image']; ?>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                ...
                <li>
                    ...
                    <li class="active">
                        <a href="loc.php"><i class="fa fa-fw fa-home"></i>Home</a>
                    </li>
                    <li>
                        <a href="enrollment.php"><i class="glyphicon glyphicon-info-sign"></i>Enroll</a>
                    </li>
                  <li>
                        <a href="enrolledcourses.php"><i class="glyphicon glyphicon-info-sign"></i>Enrolled Courses</a>
                    </li>
                     <li>
                        <a href="profile.php"><i class="glyphicon glyphicon-info-sign"></i>My Profile</a>
                    </li>
                </ul>
            </div>
        </nav>
