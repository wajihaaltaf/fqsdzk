...
<?php include('headeradmin.php'); ?>
			<nav>
                ...
                <center><h2>Deactivate<h2></center>
				<div class="col-sm-12">
				<div class="span7" id="">  
                     <div class="row-fluid">
					  <?php	
                       ...
                       ?>	
                        ...
                        <div id="block_bg" class="block">	
							...
							<br>
                                <div class="muted pull-right">&nbsp;&nbsp;&nbsp; Deactivate</div><div class="muted pull-right"><span class="label label-warning"><?php echo $count;?></span></div>
  								...
  								<table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
										...
										<tbody>
											...
											?>
												...
												<a href="deact.php<?php echo '?id='.$id.'&&email='.$email; ?>" class="btn btn-danger">Deactivate</a>
