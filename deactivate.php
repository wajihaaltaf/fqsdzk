    ...
    <div class="row-fluid">
      ...
      <div id="block_bg" class="block">
        <div class="navbar navbar-inner block-header"> <br>
          <div class="muted pull-right">&nbsp;&nbsp;&nbsp; Deactivate</div>
          <div class="muted pull-right"><span class="label label-warning"><?php echo $count;?></span></div>
              ...
              <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="col-md-1"><a href="deact.php<?php echo '?id='.$id.'&&email='.$email; ?>" class="btn btn-danger">Deactivate</a> 
                  </tr>
                  <?php }?>
                </tbody>
              </table>
